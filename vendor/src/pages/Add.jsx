        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
            ...
            <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
                <div>
                    ...
                    <select onChange={(e)=>setCategory(e.target.value)} className='w-full px-3 py-2 border border-line bg-paper outline-none focus:border-navy'>
                ...
                <div>
                    ...
                    <select onChange={(e)=>setSubCategory(e.target.value)} className='w-full px-3 py-2 border border-line bg-paper outline-none focus:border-navy'>
                ...
                <div>
                    ...
                    {/* AI price suggestion - wired to backend later */}
                    {name && category && (
