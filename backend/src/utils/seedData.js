...
// products (30 total: 6 per vendor)
    ...
    const products = await Product.insertMany([
        ...
        { name: "Handloom cotton kurta", description: "Natural cotton, machine washable. Loose fit.", price: 189900, stock: 40, vendor: vendor1._id, category: topwear._id, isActive: true },
        { name: "Khadi linen shirt", description: "100% khadi linen. Breathable summer wear.", price: 159900, stock: 25, vendor: vendor1._id, category: topwear._id, isActive: true },
        { name: "Cotton dhoti pants", description: "Easy-fit dhoti style pants. Natural off-white.", price: 129900, stock: 30, vendor: vendor1._id, category: bottomwear._id, isActive: true },
        { name: "Block print dupatta", description: "Hand block-printed on cotton. 2.5m length.", price: 89900, stock: 50, vendor: vendor1._id, category: topwear._id, isActive: true },
        { name: "Kantha stitch jacket", description: "Reversible kantha stitch jacket. Heritage print.", price: 349900, stock: 15, vendor: vendor1._id, category: topwear._id, isActive: true },
        { name: "Ikat cotton saree", description: "Handwoven double ikat cotton. 6.5m with blouse.", price: 459900, stock: 10, vendor: vendor1._id, category: topwear._id, isActive: true },

        // Modi Metals (vendor2) - home
        { name: "Brass desk lamp", description: "Adjustable brass arm lamp. Warm vintage look.", price: 249900, stock: 20, vendor: vendor2._id, category: lighting._id, isActive: true },
        { name: "Copper water jug", description: "Hammered copper jug. 1.5L capacity.", price: 159900, stock: 35, vendor: vendor2._id, category: kitchen._id, isActive: true },
        { name: "Brass candle holder set", description: "Set of 3 graduated brass holders.", price: 119900, stock: 40, vendor: vendor2._id, category: lighting._id, isActive: true },
        { name: "Bronze serving bowl", description: "Heavy bronze kansa bowl. 20cm diameter.", price: 199900, stock: 18, vendor: vendor2._id, category: kitchen._id, isActive: true },
        { name: "Copper spice box", description: "7-compartment spice box with lid. 25cm.", price: 89900, stock: 30, vendor: vendor2._id, category: kitchen._id, isActive: true },
        { name: "Brass wall sconce", description: "Handcrafted wall-mount brass sconce.", price: 279900, stock: 12, vendor: vendor2._id, category: lighting._id, isActive: true },

        // Flax & Folk (vendor3) - accessories
        { name: "Linen tote bag", description: "Heavy linen tote. 10L capacity. Natural beige.", price: 139900, stock: 45, vendor: vendor3._id, category: bags._id, isActive: true },
        { name: "Canvas backpack", description: "Waxed canvas backpack. 25L. Laptop sleeve.", price: 299900, stock: 20, vendor: vendor3._id, category: bags._id, isActive: true },
        { name: "Leather card wallet", description: "Slim 4-card slot vegetable-tanned wallet.", price: 99900, stock: 60, vendor: vendor3._id, category: wallets._id, isActive: true },
        { name: "Jute market bag", description: "Double-lined jute bag. Reinforced handles.", price: 59900, stock: 80, vendor: vendor3._id, category: bags._id, isActive: true },
        { name: "Bi-fold leather wallet", description: "Full-grain leather. 8 card slots + cash.", price: 149900, stock: 35, vendor: vendor3._id, category: wallets._id, isActive: true },
        { name: "Woven belt bag", description: "Cotton and jute woven belt bag. Adjustable.", price: 119900, stock: 25, vendor: vendor3._id, category: bags._id, isActive: true },

        // Bagru Prints (vendor4) - clothing
        { name: "Bagru print kurta", description: "Natural dye block-print. Mulmul cotton.", price: 169900, stock: 35, vendor: vendor4._id, category: topwear._id, isActive: true },
        { name: "Dabu print shirt", description: "Traditional dabu resist-print. Loose fit.", price: 149900, stock: 28, vendor: vendor4._id, category: topwear._id, isActive: true },
        { name: "Mud-resist print trousers", description: "Mud-resist print cotton trousers. Elastic waist.", price: 139900, stock: 22, vendor: vendor4._id, category: bottomwear._id, isActive: true },
        { name: "Ajrakh print shirt", description: "Authentic ajrakh block-print. Geometric motifs.", price: 179900, stock: 18, vendor: vendor4._id, category: topwear._id, isActive: true },
        { name: "Block-print scarf", description: "Cotton voile scarf. 180x70cm. Natural dyes.", price: 79900, stock: 55, vendor: vendor4._id, category: topwear._id, isActive: true },
        { name: "Indigo kurta set", description: "Indigo-dyed kurta and churidar set. Hand-stitched.", price: 389900, stock: 12, vendor: vendor4._id, category: topwear._id, isActive: true },

        // Indigo House (vendor5) - home + accessories
        { name: "Indigo table runner", description: "Natural indigo linen runner. 180x35cm.", price: 89900, stock: 40, vendor: vendor5._id, category: kitchen._id, isActive: true },
        { name: "Linen napkin set", description: "Set of 6 indigo-dyed linen napkins.", price: 119900, stock: 30, vendor: vendor5._id, category: kitchen._id, isActive: true },
        { name: "Indigo denim tote", description: "Selvedge denim tote bag. 15L.", price: 169900, stock: 25, vendor: vendor5._id, category: bags._id, isActive: true },
        { name: "Wabi-sabi ceramic mug", description: "Hand-thrown ceramic. 300ml. Dishwasher safe.", price: 69900, stock: 50, vendor: vendor5._id, category: kitchen._id, isActive: true },
        { name: "Shibori throw cushion", description: "Shibori-dyed linen cushion cover. 45x45cm.", price: 99900, stock: 35, vendor: vendor5._id, category: kitchen._id, isActive: true },
        { name: "Kantha quilt", description: "Hand-stitched kantha quilt. Single size. 100% cotton.", price: 599900, stock: 8, vendor: vendor5._id, category: kitchen._id, isActive: true },
    ]);
...
// orders (10 orders across 2 buyers)
    ...
    await Order.insertMany([
        ...
        },
        {
            ...
            shippingAddress: { addressLine1: "45 Anna Salai", city: "Chennai", state: "Tamil Nadu", pinCode: "600002", country: "India" },
